...
/**
 * 
 * @author TianZhao Time 2015年11月26日 xiyouMobile
 */
...
public class CustomerViewPage extends RelativeLayout implements Runnable {
	...
	/**
	 * 底部指示物在父View(即viewDots视图)的gravity属性,默认在中间 Gravity.RIGHT | Gravity.LEFT |
	 * Gravity.CENTER
	 */
